...
for (let user of users){
  popUp += ("User ID is " + user.id  + " called: " + user.name + " living in: " + user.address.city)
}
...
let popUpUserID = prompt("Type your User ID please (numbers)");

console.log(popUpUserID);

// pjesa e trete

let popUp1 = "";
for(let user of users){
  if (popUpUserID === user.id)
  popUp1 = popUp1 + ("Your username is: " + user.username)
}

for (let todo of todos){
    if (popUpUserID === todo.userId){
        popUp1 = popUp1 + todo.title ;
    }
}
alert(popUp1);
